...
- [CF 2259C — "101"](* [CF 2259C — "101"](https://github.com/Mojahidul21/My-Competitive-Programming-Journey/blob/main/Upsolve/Codeforces/Codeforces%20Round%201119%20(Div.%203)/C.%20101.md) — worked example of the pattern outside number theory: two anchors found directly, everything between derived, no score simulated.) — worked example of the pattern outside number theory: two anchors found directly, everything between derived, no score simulated.
