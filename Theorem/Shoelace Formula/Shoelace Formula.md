...
_Note: First, try to compute B by code at your own. If it requires, follow the boundary() function coded in the solution of **Polygon Lattice Points** in section 10._ 
...
_Note: As I is always integer, hence you have to tackle floating value because of $\frac{B}{2}$ . Think first at your own - **how to tackle it**? If it requires, follow the functions coded in the solution of **Polygon Lattice Points** in section 10._
